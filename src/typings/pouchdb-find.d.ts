...
declare namespace PouchDB {
  ...
  type Selector = Selector_value | Selector_lt | Selector_gt | Selector_lte | Selector_gte | Selector_eq | Selector_ne | Selector_exists | Selector_type | Selector_and | Selector_or
