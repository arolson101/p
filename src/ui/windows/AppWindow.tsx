...
export const AppWindow = ({title, onBack, onForward, children}: AppWindowProps & React.Props<any>) =>
  <Window chrome>
    <Helmet
      link={[
        { rel: 'stylesheet', type: 'text/css', href: 'lib/css/metro.css' },
        { rel: 'stylesheet', type: 'text/css', href: 'lib/css/metro-icons.css' },
        { rel: 'stylesheet', type: 'text/css', href: 'lib/css/metro-bootstrap.css' },
      ]}
    />
