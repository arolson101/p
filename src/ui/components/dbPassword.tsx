...
type AllProps = Props & RouteProps<Params> & ConnectedProps & IntlProps & ReduxFormProps<Values>
...
export const DbPasswordComponent = (props: AllProps) => {
  if (!props.dbDoc) {
    return null as any
  }
...
export const DbPassword = compose(
  injectIntl,
  connect(
...
)(DbPasswordComponent) as React.ComponentClass<Props>
